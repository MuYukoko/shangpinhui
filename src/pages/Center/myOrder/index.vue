          ...
          <div class="order-content">
            ...
            <div class="orders">
              <table class="order-item" v-for='(order,index) in myOrder.records' :key="index">
                ...
                <tbody>
                  <tr v-for="(orderDetail,index) in order.orderDetailList" :key="index">
                    <td width="60%">
                      <div class="typographic">
                        <img :src="orderDetail.imgUrl" style="width:100px">
                        <a href="#" class="block-text">{{orderDetail.skuName}}</a>
                        <span>x1</span>
                        <a href="#" class="service">售后申请</a>
                      </div>
                    </td>
                    <td :rowspan="order.orderDetailList.length" width="8%" class="center" v-show="index==0">小丽</td>
                    <td :rowspan="order.orderDetailList.length" width="13%" class="center" v-show="index==0">
                      <ul class="unstyled">
                    ...
                    <td :rowspan="order.orderDetailList.length" width="8%" class="center" v-show="index==0">
