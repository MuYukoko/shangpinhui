          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" :class="{'active':saleAttrValue.isChecked==='1'}" v-for="saleAttrValue in spuSaleAttr.spuSaleAttrValueList" :key="saleAttrValue.id" @click='changeCheck(saleAttrValue,spuSaleAttr.spuSaleAttrValueList)'>{{saleAttrValue.saleAttrValueName}}</dd>
              </dl>
