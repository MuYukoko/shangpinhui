  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for='userAddress in userAddressList' :key="userAddress.id">
        ...
        <p @click="changeAddressDefault(userAddress,userAddressList)">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="order in orderInfo.detailArrayList" :key="order.index">
          <li>
...
<script>
  ...
  export default {
    ...
    methods: {
      changeAddressDefault(userAddress,userAddressList){
