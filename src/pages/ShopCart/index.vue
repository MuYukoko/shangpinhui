  ...
  export default {
    ...
    methods: {
      ...
      handler:throttle(async function(type,disNum,cart){
        ...
        try {
          await this.$store.dispatch('detail/addOrUpdateShopCart',{skuNum:disNum,skuId:cart.skuId})
           this.reqShopCart()
        } catch(error){
          console.log(error);
        }
      ...
      async updateChecked(cart,event){
        ...
        try {
          await this.$store.dispatch('shopcart/updateShopCartChecked',{skuId:cart.skuId,isChecked});
          this.reqShopCart();
        } catch (error) {
          alert(error.message)
        }
